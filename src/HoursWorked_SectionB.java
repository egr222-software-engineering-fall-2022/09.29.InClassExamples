...
public class HoursWorked_SectionB {
    public static void main(String[] args) throws FileNotFoundException {
        Scanner input = new Scanner(new File("hours.txt"));
        PrintStream outputFile = new PrintStream(new File("hours_out.txt"));
        ...
        while (input.hasNextLine()) {
            ...
            outputFile.println(name + " worked " + totalHours + " hours (" + totalHours / days + " hours/day)");
        }
    }
}
